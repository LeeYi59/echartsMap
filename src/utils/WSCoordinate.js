 ...
 *  判断经纬度是否超出中国境内
 */
export const isLocationOutOfChina = (latitude, longitude) => {
 ...
 */
export const transformFromWGSToGCJ = (latitude, longitude) => {
  var lat = "";
  var lon = "";
 ...
 *  将GCJ-02(火星坐标)转为百度坐标:
 */
export const transformFromGCJToBaidu = (latitude, longitude) => {
  var pi = 3.14159265358979324;
 ...
 *  将百度坐标转为GCJ-02(火星坐标):
 */
export const transformFromBaiduToGCJ = (latitude, longitude) => {
 ...
 */
export const transformFromGCJToWGS = (latitude, longitude) => {
...
export const isContains = (point, p1, p2) => {
...
export const transformLatWithXY = (x, y) => {
  var pi = 3.14159265358979324;
...
export const transformLonWithXY = (x, y) => {
  var pi = 3.14159265358979324;
